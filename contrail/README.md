...
6. Now the installation of openstack, contrail networking, appformix and contrail command is done. You can start playing around with it or you can follow the following [lab exercise](https://github.com/m1r24n/running_on_vmm/contrail_lab_exercise)
